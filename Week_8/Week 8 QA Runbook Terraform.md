...
![Compute Engine to Image Template](./HW_8_Screenshots/Compute Engine to Image Template.png)
![Create instance template](./HW_8_Screenshots/Create instance template.png)
...
![Compute Engine to Instance Group](./HW_8_Screenshots/Compute Engine to Instance Group.png)
